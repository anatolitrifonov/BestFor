...
namespace BestFor.Domain.Masks
{
    ...
    /// </summary>
    public class AnswerLeftMask : IFirstIndex, ISecondIndex, IDtoConvertable<AnswerDto>, IIdIndex
    {
        /// <summary>
        /// Copy data from answer
        /// </summary>
        /// <param name="answer"></param>
        public AnswerLeftMask(Answer answer)
        {
            Id = answer.Id;
        ...
        /// </summary>
        public string IndexKey { get { return LeftWord; } }
        #endregion
