...
{
    /// <summary>
    /// Mask answer by right word - index by right word.
    /// 
    ...
    /// </summary>
    public class AnswerRightMask : IFirstIndex, ISecondIndex, IDtoConvertable<AnswerDto>, IIdIndex
    {
        /// <summary>
        /// Copy data from answer
        /// </summary>
        /// <param name="answer"></param>
        public AnswerRightMask(Answer answer)
        {
            Id = answer.Id;
        ...
        /// </summary>
        public string IndexKey { get { return RightWord; } }
        #endregion
